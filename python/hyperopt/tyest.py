...
if __name__ == "__main__":
    with open('python/hyperopt/catb_best_params.pickle', 'rb') as outfile:
        par = pickle.load(outfile)
    ...
    #trials = Trials()
    #best = fmin(f, space4rndF, algo=tpe.suggest, max_evals=100, trials=trials)
    #print('best:')
    #print(best)

    with open('best_train_index_501.txt', 'w') as outfile:
        json.dump(list(idx), outfile)
